...
```bash
git remote add encore encore://indoblockforge-platform-r9zi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/indoblockforge-platform-r9zi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/indoblockforge-platform-r9zi/settings/integrations/github)
